...
\newcommand{\subtitle}[1]{\def\@subtitle{#1}} % fixes title in .pdf (I don't why we need this)
...
\renewcommand{\rmdefault}{phv} % Set the default font to Helvetica

% Custom section spacing and formatting
\titleformat{\part}{\Huge\scshape\filcenter}{}{1em}{}
\titleformat{\section}{\Large\bf\raggedright}{}{1em}{}[{\titlerule[1pt]}]
